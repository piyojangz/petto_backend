                ...
                <form class="form-horizontal new-lg-form" id="loginform" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <a href="javascript:void(0)" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> ลืมรหัสผ่าน?</a>
                        </div>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-lg btn-block  text-uppercase waves-effect waves-light" type="submit">เข้าสู่ระบบ
                            </button>
                        </div>
                    </div>
                    <!--                    <div class="row">
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p class="text-center">ยังไม่มีบัญชี? <a class="text-primary m-l-5" href="<?= base_url("register") ?>" style="font-weight: bold;"> คลิกที่นี่ </a>
