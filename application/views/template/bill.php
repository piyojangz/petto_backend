                                    ...
                                    <div class="col-xs-8">
                                        ...
                                        <span class="itemname"><a href="javascript:;"
                                                ...
                                                <i class="fa fa-external-link-square"
                                                   style="    font-size: .7em;  padding-left: 4px;"></i></a></span>
                                        <br/> <span class="itemprice"><?= number_format($item->price, 2, '.', ','); ?>
                                            ฿</span>
                                    </div>
                                    <div class="col-xs-4">
                                        ...
                                        <input type="number" name="amount" min="0"
                                               class="form-control input-sm itemamount"
                                               value="<?= $obj->getamount($orderdetail, $item->id) ?>" placeholder="0"
                                               autocomplete="off"/>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="hidden" value="<?= $item->id ?>"/>
                                        <input type="hidden" value="<?= $item->price ?>"/>
                                        <input type="number" name="shippingdiscount"
                                               class="form-control input-sm itemamount" placeholder="0"
                ...
                <?php foreach ($paymentmethod as $index => $item): ?>
                    <label class="bank" for="checkbox<?= $index ?>">
                        <input name="paymenttype" type="radio" id="checkbox<?= $index ?>" required
                               value="<?= $item->id ?>" <?= $item->id == $order->paymentmethodid ? 'checked' : '' ?>/>
