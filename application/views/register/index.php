        ...
        <div class="lg-info-panel">
            <div class="inner-panel">
                ...
                <div class="lg-content">
                    ...
                    <a href="<?= base_url("login") ?>" class="btn btn-rounded btn-danger p-l-20 p-r-20">ต้องการเข้าสู่ระบบ?</a>
                </div>
            </div>
        </div>
            ...
            <div class="white-box">
                ...
                <form  class="form-horizontal new-lg-form"  action="" method="post" enctype="multipart/form-data" id="formsubmit"> 
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-lg btn-block  text-uppercase waves-effect waves-light" type="submit">สมัครสมาชิก</button>
                        </div>
                    </div>
