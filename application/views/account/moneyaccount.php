                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="accountbranch" id="accountbranch" required class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="accountno" id="accountno" required class="form-control" maxlength="10">
                                                        </div>
                                                    </div>
