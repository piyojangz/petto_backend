                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box p-l-20 p-r-20">
                            <h3 class="box-title m-b-0">ตั้งค่าหน้าเกี่ยวกับเรา</h3>
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" method="post" action="<?= base_url("account/$token/updateaboutsetting") ?>" id="form-submit">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div style="width: 795px; margin: 0 auto">
                                                    <textarea id="customtext" name="customtext" class="summernote"><?= $textabout->description ?></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <button type="submit" class="btn btn-block btn-outline btn-rounded btn-primary">บันทึก
                                        </button>
                                    </form>
                                </div>
                            </div>
