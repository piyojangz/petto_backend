            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box p-l-20 p-r-20">
                        <h3 class="box-title m-b-0">ตั้งค่าหน้า Google Analytic</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <form class="form-horizontal" method="post"
                                      action="<?= base_url("account/$token/updategganalyticsetting") ?>"
                                      id="form-submit">

                                    <input type="hidden" id="id" name="id" value="<?= isset($ggscript)?$ggscript->id:'' ?>">
                                    <div class="form-group">
                                        <label class="col-md-12">script</label>
                                        <div class="col-md-12">
                                            <div style="width: 795px; margin: 0 auto">
                                                <textarea style="width: 100%;height: 450px;" id="customtext"
                                                          name="customtext"><?= isset($ggscript)?$ggscript->script:'' ?></textarea>
                                            </div>
                                        </div>
