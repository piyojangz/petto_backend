                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="wizard-steps">
                            ...
                            <li style="cursor: pointer;"
                                onclick="location.href = '<?= base_url("account/$token/paymentmethod") ?>'">
                                <h4><span>4</span>บัญชีธนาคาร</h4></li>
                            <li style="cursor: pointer;"
                                onclick="location.href = '<?= base_url("account/$token/shippingrate") ?>'">
                    ...
                    <div class="white-box analytics-info">
                        ...
                        <ul class="list-inline">
                            <li class="text-right"><i class="ti-arrow-up text-success"></i> <span
                                        class="counter text-success"><?= $dashboarddata->bills ?></span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="white-box analytics-info">
                        ...
                        <ul class="list-inline">
                            <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span
                                        class="counter text-purple"><?= $dashboarddata->paid ?></span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="white-box analytics-info">
                        ...
                        <ul class="list-inline two-part">
                            <li class="text-right"><i class="ti-arrow-up text-danger"></i> <span
                                        class="counter text-danger"><?= $dashboarddata->unpaid ?></span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="white-box analytics-info">
                        ...
                        <ul class="list-inline">
                            <li class="text-right"><i class="ti-arrow-up text-success"></i> <span
                                        ...
                                        class="counter text-success"><?= number_format($dashboarddata->monthlytotal) ?></span>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <table class="table no-paging">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <div class="btn-group">
                                                    <button id="btn-refreshbilltoken" type="button"
                                            ...
                                            <th class="hidden-xs" width="100">
                                                <div class="btn-group pull-right">
                                                    <button type="button"
                                                            class="btn-genbill btn btn-default waves-effect"><i
                                ...
                                <div class="row" id="billtokengraph">
                                    <div class="col-md-12 col-lg-12 col-xs-12">
                                        <div class="white-box">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p>การแจ้งเตือนถึง <span id="billusernotification"
                                                                             class="text-purple"></span></p>
                                                </div>
                                                <div class="col-md-6">
                                                    <button id="billtokenremove"
                                                            class="pull-right btn btn-outline btn-danger waves-effect waves-light">
                                                        ลบ
                                                    </button>
                                                    <button id="billtokenedit"
                                                            class="pull-right btn btn-outline btn-default waves-effect waves-light"
                                                            style="margin-right: 15px;">แก้ไข
                                                    </button>
                                                    <button id="billupdatestock"
                                                            class="pull-right btn btn-outline btn-primary waves-effect waves-light"
                                                            style="margin-right: 15px;">STOCK <span
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="white-box panel-wrapper collapse in  p-b-0">
                        <div class="panel-body ">
                            ...
                            <div class="col-xs-6">
                                <div class="btn-group pull-right">
                                    <button type="button" class="btn-createadminlink btn btn-primary waves-effect"><i
                                                class="fa fa-plus"></i></button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="panel panel-default" style="border:  1px #f5f5f5 solid">
                                        <div class="panel-heading"><?= $value->name ?>
                                            <small>- <a href="javascript:;"
                                                        onclick="opensalehistory('<?= $value->lineuid ?>',0,30)">ยอดขาย <?= number_format($value->total) ?></a>
                                            </small>
                                            ...
                                            <?php endif; ?>
                                            <div class="pull-right"><a href="javascript:;"
                                                                       onclick="deleteadminuid('<?= $value->id ?>')"><i
                                                            class="ti-close text-danger"></i></a></div>
                                        </div>
                                                ...
                                                <?php else: ?>
                                                    <p>นำรหัสนี้ไปให้ <strong><?= $value->name ?></strong>
                                                        ...
                                                        <button class="btn btn-outline btn-default btn-xs"
                                                                onclick="copyuid(event, '<?= $value->invitetoken ?>')">
                                                            copy
                                                        </button>
                                                    </p>
                                                <?php endif; ?>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <button type="button" onclick="loadmore()"
                                                    class="btn btn-outline btn-default" style="width: 100%;">Loadmore
                                            </button>
...
//        });
    ...
    function opensalehistory(lineuid,offset,limit) {
        $("#offset").val(offset);
        $("#lineuid").val(lineuid);
        $.magnificPopup.open({items: {src: '#form-sale-history'}, type: 'inline'}, 0);
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('service/getsalehistory'); ?>",
            data: {'lineuid': lineuid, 'merchantid': <?= $merchant->id ?>, 'offset': offset, 'limit': limit},
            dataType: "html",
            success: function (data) {
