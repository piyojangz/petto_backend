            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">ตั้งค่าภาษา</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="active"><a href="#">ตั้งค่าภาษา</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">TH</label>
                                                <div class="col-md-9">
                                                    <input id="th" name="th[]" type="text" class="form-control" value="<?= $value->th ?>">
                                                    <input id="id" name="id[]" type="hidden" class="form-control" value="<?= $value->id ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="en" name="en[]" type="text" class="form-control" value="<?= $value->en ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">CN</label>
                                                <div class="col-md-9">
                                                    <input id="cn" name="cn[]" type="text" class="form-control" value="<?= $value->cn ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                                <button type="submit" class="btn btn-block btn-outline btn-rounded btn-primary">บันทึก</button>
                            </div>
                        </form>
                    </div>
